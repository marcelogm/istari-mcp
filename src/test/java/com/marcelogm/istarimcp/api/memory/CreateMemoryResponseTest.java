...
class CreateMemoryResponseTest {
    ...
    void shouldCreateResponseWithAllFields() {
        ...
        final var suggestions = List.of(
                new MemorySuggestionResponse(UUID.randomUUID(), "Suggestion 1", 0.9f),
                new MemorySuggestionResponse(UUID.randomUUID(), "Suggestion 2", 0.8f)
        );
        ...
        assertEquals(0.9f, response.suggestions().get(0).correlation());
    }
}
